<template>
  <aside
    class="w-full sm:w-56 flex-shrink-0 bg-white border-r border-gray-100 h-full py-6 px-2 flex flex-col gap-2 sticky top-12 z-30 overflow-y-auto rounded-xl shadow"
  >
